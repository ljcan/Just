    		...
    		<div class="menu_left">
                <div class="scholor_title">
                   <a href="applications_box.html"><img src="../images/some.png" width=22 height=22 alt="发布动态"/><span>发布动态</span></a>
		    		<a href="./"><img src="../images/paper.png" width=28 height=26 alt="我的空间"/><span>我的空间</span></a>
    			...
    			<div class="menu_left01" style="height: auto !important;">
    		     	<div class="crumbs">
    		     		...
    		     		<a href="">全部评论</a>
    		     		<a href="#2">></a>
    		     		<a href="../html/comment.jsp?id=${c_message_id}" class="add_color">添加</a>
    		     	</div>
    		     	<div class="strip"></div>
    		     		<c:forEach items="${commentList}" var="list" varStatus="status">
	    		     	<label for="" style="color:#7D9EC0">&nbsp;&nbsp;&nbsp;&nbsp;${list.c_user }：</label>${list.c_comment}</br>
	    		     	</c:forEach>
	    		     	<br />
	    		     </form>
	    		</div>   
