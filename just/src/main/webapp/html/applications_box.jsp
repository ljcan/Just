...
<!-- /********************头部start***************************/ -->
    <div class="scholor_head">
        <div class="scholor_content clearfix">
            <a href="../personal/show.spring"  class=""><img src="${param.image}" alt="我的头像"/></a>
            ...
            <div class="information">
              ...
              <a href="#2" class="set"><span class="set_btn"></span><span class="quit">退出</span></a>
    	...
    	<div class="menu_main clearfix">
    		...
    		<div class="menu_left">
                <div class="scholor_title">
                   <a href="#2"><img src="../images/some.png" width=22 height=22 alt="发布动态"/><span>发布动态</span></a>
    			...
    			<div class="menu_left01" style="height: auto !important;">
    		     	<div class="crumbs">
    		     		...
    		     		<a href="">任务信息</a>
    		     		<a href="#2">></a>
    		     		<a href="#2" class="add_color">添加</a>
    		     	</div>
    		     	<div class="strip"></div>
    		     	<!-- 
    		     	<form class="form" enctype="multipart/form-data" method="post" action="../image/updateMessage_Image.spring">
    		     	<label for="">上传图片：</label><input type="file" name="message_image" value="" /><input class="btn" type="submit" name="" id="" value="上传" />
    		     	<input type="hidden" name="user_id" value="${param.user_id}">
    		     	</form> 
    		     	-->
    		     	 <form action="../message/publishTask.spring" method="post" class="form" enctype="multipart/form-data">
    		     		 <label for="">上传图片：</label><input type="file" name="message_image" value="" />	<br />
	    		     	<label for="">动态内容：</label><textarea  rows="10" cols="20" name="content" value="" placeholder="说点什么吧......（200字以内）" style="padding-left:1rem"></textarea>
	    		     	<br />
